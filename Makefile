...
ifeq (postpackaging,$(findstring $(MAKECMDGOALS),postpackaging))
  ...
  LA32_PACKAGE_FILENAME = gcc-arm-none-eabi-10-2020-q4-major-armv7l-linux.tar.bz2
  LA32_PACKAGE_CHKSUM := $(firstword $(shell shasum -a 256 "$(LA32_PACKAGE_FILENAME)"))
  LA32_PACKAGE_SIZE := $(firstword $(shell wc -c "$(LA32_PACKAGE_FILENAME)"))
...
all: clean print_info
	...
	wget -O gcc-arm-none-eabi-10-2020-q4-major-armv7l-linux.tar.bz2 https://github.com/fortytwosystems/ArduinoModule-gcc-arm-none-eabi/releases/download/10-2020q4/gcc-arm-none-eabi-10-2020-q4-major-armv7l-linux.tar.bz2
...
postpackaging:
	...
	@echo "LA64_PACKAGE_CHKSUM     = $(LA32_PACKAGE_CHKSUM)"
	@echo "LA64_PACKAGE_SIZE       = $(LA32_PACKAGE_SIZE)"
	@echo "LA64_PACKAGE_FILENAME   = $(LA32_PACKAGE_FILENAME)"
